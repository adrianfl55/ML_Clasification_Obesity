...
function modelCrossValidationModificada(modelType::Symbol, modelHyperparameters::Dict, inputs::AbstractArray{<:Real,2}, targets::AbstractArray{<:Any,1}, crossValidationIndices::Array{Int64,1})
...
#            maxEpochsVal      = get(modelHyperparameters, "maxEpochsVal",      20);
    ...
    return testAccuracy, testErrorRate, testRecall, testSpecificity, testPrecision, testNPV, testF1;
end;
